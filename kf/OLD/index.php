...
<html>
	...
	<script>
		...
		var agitatorSpeed;
		var internalCirculationSpeed;
		var speedHomogenizer;
		...
		function mulai(){
			var gaugeOptions = {
				...
				if (chartRpm) {
				    ...
				    //newVal = point.y + inc;
					//newVal = Math.random();
					newVal = parseFloat(speedHomogenizer);
				    point.update(newVal);
				  }
				 if (chartRpm1) {
				    ...
				    //newVal = point.y + inc;
					//newVal = Math.random();
					newVal = parseFloat(agitatorSpeed);
				    point.update(newVal);
				  }
				  if (chartRpm2) {
				    ...
				    //newVal = point.y + inc;
					//newVal = Math.random();
					newVal = parseFloat(internalCirculationSpeed);
				    point.update(newVal);
				  }
				}, 5000);
		}
		function ajax_1(){
			$.ajax({
				...
				success : function(html){
					var data  = html;
					$("#valueDosingWater").html(JSON.parse(data).dosing_water.split(","));

					speedHomogenizer = JSON.parse(data).inflight_time.split(",");
					$("#valueInflightTime").html(JSON.parse(data).inflight_time.split(","));
					$("#valueTemperature").html(JSON.parse(data).temp.split(","));
					$("#valueFlushingTime").html(JSON.parse(data).flushing_time.split(","));
				},
				error : function(){
					alert("Error");
				}
		...
		function ajax_2(){
			$.ajax({
				...
				success : function(html){
					...
					var data  = html;
					$("#valuePressure").html(JSON.parse(data).pressure.split(","));
					$("#valueHisterisis").html(JSON.parse(data).histerisis.split(","));
					$("#valueAgitatorSpeed").html(JSON.parse(data).agitator_speed.split(","));
					$("#valueAgitatorTime").html(JSON.parse(data).agitator_time.split(","));
					$("#valueInternalCirSpeed").html(JSON.parse(data).internal_cir_speed.split(","));
					$("#valueInternalCirTime").html(JSON.parse(data).internal_cir_time.split(","));
					$("#valueHomogenizer").html(JSON.parse(data).speed_homogenizer.split(","));


					agitatorSpeed = JSON.parse(data).agitator_speed.split(",");
					internalCirculationSpeed = JSON.parse(data).internal_cir_speed.split(",");
					//speedHomogenizer = JSON.parse(data).speed_homogenizer.split(",");
				},
				error : function(){
					alert("Error");
				}
				...
				<div class="myKPI_DosingPw">
					...
					<div class="contentKPI" style="background: #00C0EF">
						<table style="width: 100%;">
							...
							<tr>
								<td class="valueKPI"><span id="valueDosingWater" style="font-size: 30px;">0<span style="font-size: 15px;"> kg</span></span></td>
							</tr>
							<tr>
								<td><hr></td>
							</tr>
				...
				<div class="myKPI_DosingPw">
					...
					<div class="contentKPI" style="background: #DD4B39">
						<table style="width: 100%;">
							...
							<tr>
								<td class="valueKPI"><span id="valueInflightTime" style="font-size: 30px;">0<span style="font-size: 15px;"> s</span></span></td>
							</tr>
							<tr>
								<td><hr></td>
							</tr>
				...
				<div class="myKPI_DosingPw">
					...
					<div class="contentKPI" style="background: #F39C12">
						<table style="width: 100%;">
							...
							<tr>
								<td class="valueKPI"><span id="valueTemperature" style="font-size: 30px;">0<span style="font-size: 15px;"> c</span></span></td>
							</tr>
							<tr>
								<td><hr></td>
							</tr>
				...
				<div class="myKPI_DosingPw">
					...
					<div class="contentKPI" style="background: #9CDB3A">
						<table style="width: 100%;">
							...
							<tr>
								<td class="valueKPI"><span id="valueFlushingTime" style="font-size: 30px;">0<span style="font-size: 15px;"> s</span></span></td>
							</tr>
							<tr>
								<td><hr></td>
							</tr>
									...
									<td class="valueKPI">
										<div class="row">
											<div class="col-7" style="text-align: right;padding-right: 0px;">
												<span id="valuePressure" style="font-size: 80px;">0</span>
											</div>
											<div class="col-5">
												<br><br><br>
								...
								<table style="width: 100%;">
									...
									<tr>
										<td class="valueKPI">
											<div class="row">
												<div class="col-7" style="text-align: right;padding-right: 0px;">
													<span id="valueHisterisis" style="font-size: 80px;">0</span>
												</div>
												<div class="col-5">
													<br><br><br>
													<span style="font-size: 30px;vertical-align: bottom;">bar</span>
								...
								<table style="width: 100%;">
									...
									<tr>
										<td class="valueKPI">
											<div class="row">
												<div class="col-7" style="text-align: right;padding-right: 0px;">
													<span id="valueAgitatorTime" style="font-size: 50px;"></span>
												</div>
												<div class="col-5">
													<br><br>
								...
								<table style="width: 100%;">
									...
									<tr>
										<td class="valueKPI">
											<div class="row">
												<div class="col-7" style="text-align: right;padding-right: 0px;">
													<span id="valueInternalCirTime" style="font-size: 50px;">0</span>
												</div>
												<div class="col-5">
													<br><br>
													<span style="vertical-align: bottom;">bar</span>
