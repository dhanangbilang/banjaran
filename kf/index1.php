	...
	<body>
		...
		<div id="myLeftPanel" style="padding: 5px;">
		    ...
		    border-bottom: 1px solid white;">LIQUID PRODUCTION LINE</a></li>
					<li><a class="mySideMenu" href="#" style="color:white;background: #222C32;">Mixing Liquid & Holding Tank</a></li>
		...
		<div id="myRightPanel">
			...
			<div class="myBlock myMixing"><!-- Agitator -->
				<center>
					...
					<span class="myLabelText" style="margin: 0;" id="labelAgitatorTime">Agitator Time : 30 sec</span>
				</center>
			</div>
			...
			<div class="myBlock myMixing"><!-- Internal cirsulation -->
				<center>
					...
					<span class="myLabelText" style="margin: 0;"  id="labelCirsulationTime">Cirsulation Time : 30 sec</span>
				</center>
			</div>
		</div>
	</body>
