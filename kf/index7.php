	...
	<body>
		...
		<div id="myLeftPanel" style="padding: 5px;">
		    ...
		    border-bottom: 1px solid white;">NON-BL & PILOT PRODUCTION LINE</a></li>
					...
					<li><a class="mySideMenu" href="#" style="color:white;background: #222C32;">Coating Bosch</a></li>
				</ul>
			</div>
		</div>
		<div id="myRightPanel">
			<span class="myLabelText">Coating Bosch</span><br>
			...
			<div class="myBlock mybosch1">
				<div style="width: 70%;height: auto; margin: 5px 0 0 15%; float: left;">
						<center>
							<span class="myLabelText">Drum Speed</span>
							<div class="o2" id="cir1"></div>
						</center>
					</div>
			</div>
			<div class="myBlock mybosch2">
				<div style="width: 100%;height: auto; padding: 10px 10px; float: left;">
						<span class="myTextKPI">Inlet AirFlow  : <span style="background: #ffecc8;padding: 2px 5px;border-radius: 5px; color: black;">10 m/hour</span></span><br>
						<span class="myTextKPI">Inlet Temp  : <span style="background: #ffecc8;padding: 2px 5px;border-radius: 5px;color: black;">10 &#8451;</span></span><br>
						<span class="myTextKPI">Exhaust Temp  : <span style="background: #ffecc8;padding: 2px 5px;border-radius: 5px;color: black;">10 &#8451;</span></span><br>
						<span class="myTextKPI">Process Temp  : <span style="background: #ffecc8;padding: 2px 5px;border-radius: 5px;color: black;">10 &#8451;</span></span><br>
						<span class="myTextKPI">Inlet Humidity  : <span style="background: #ffecc8;padding: 2px 5px;border-radius: 5px;color: black;">10 g/Kg</span></span><br>
						<span class="myTextKPI">Spray Rate  : <span style="background: #ffecc8;padding: 2px 5px;border-radius: 5px;color: black;">10 ml/min</span></span><br>
						<span class="myTextKPI">Atomizing Air Pressure  : <span style="background: #ffecc8;padding: 2px 5px;border-radius: 5px;color: black;">10 bar</span></span><br>
						<span class="myTextKPI">Spray Width Air  : <span style="background: #ffecc8;padding: 2px 5px;border-radius: 5px;color: black;">10 bar</span></span><br>
					</div>
			</div>
		</div>
	</body>
