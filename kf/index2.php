	...
	<body>
		...
		<div id="myLeftPanel" style="padding: 5px;">
		    ...
		    border-bottom: 1px solid white;">LIQUID PRODUCTION LINE</a></li>
					...
					<li><a class="mySideMenu" href="#" style="color:white;background: #222C32;">Filling Liquid</a></li>
		...
		<div id="myRightPanel">
					...
					var config2 = {
						...
						data: {
							...
							datasets: [{
								...
								lineTension: 0,
								data: [
									10,20,30,40,50,60,70,80,90,110,110,110,110,110,110,110,110,110,110,110,110,110,110,110
								],
								fill: false,
							}, {
								label: 'Inflight Time',
								...
								lineTension: 0,
								data: [
									20,30,40,50,60,70,80,90,120,120,120,120,120,120,120,120,120,120,120,120,120,120,120,120
								],
							},{
								label: 'Temperature',
								fill: false,
								...
								lineTension: 0,
								data: [
									30,40,50,60,70,80,90,130,130,130,130,130,130,130,130,130,130,130,130,130,130,130,130,130
								],
							},{
								label: 'Temperature',
								fill: false,
								...
								lineTension: 0,
								data: [
									40,50,60,70,80,90,140,140,140,140,140,140,140,140,140,140,140,140,140,140,140,140,140,140
								],
							},{
								label: 'Flushing Time',
								fill: false,
								...
								lineTension: 0,
								data: [
									50,60,70,80,90,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150
								],
							}]
						},
						options: {
			...
			<div class="myBlock myChartHistory">
				<div style="width:100%;">
					<canvas id="canvas2" height="200vw" width="520vw"></canvas>
				</div>
			</div>
			<br>
			<span class="myLabelText">Real Time Data - <span style="background: #4675f7;padding: 2px 5px;border-radius: 5px;">Device 1</span></span></br>
			<div class="myBlock myMixing"><!-- Agitator -->
				<center>
					<span class="myLabelText" style="margin: 0;">Speed</span>
					<div class="o2" id="cir1"></div>
				</center>
			</div>
			<div class="myBlock myMixing"><!-- Pressure -->
				<center>
					<span class="myLabelText" style="margin: 0;">Air Pressure</span>
					<div class="o2" id="cir3"></div>
				</center>
			</div>
			<div class="myBlock myMixing"><!-- Histerisi -->
				<center>
					<span class="myLabelText" style="margin: 0;">Volume</span>
					<div class="o2" id="cir4"></div>
				</center>
			</div>
			<div class="myBlock myMixing"><!-- Homogenizer -->
				<center>
					<span class="myLabelText" style="margin: 0;">Capping Pressure</span>
					<div class="o2" id="cir5"></div>
				</center>
			</div>
			<div class="myBlock myMixing"><!-- Internal cirsulation -->
				<center>
					<span class="myLabelText" style="margin: 0;">Labeling Speed</span>
					<div class="o2" id="cir2"></div>
				</center>
			</div>
			<br>
			<span class="myLabelText">Real Time Data - <span style="background: #f74677;padding: 2px 5px;border-radius: 5px;">Device 2</span></span></br>
			<div class="myBlock myMixing"><!-- Agitator -->
				<center>
					<span class="myLabelText" style="margin: 0;">Speed</span>
