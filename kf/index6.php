	...
	<body>
		...
		<div id="myLeftPanel" style="padding: 5px;">
		    ...
		    border-bottom: 1px solid white;">NON-BL & PILOT PRODUCTION LINE</a></li>
					...
					<li><a class="mySideMenu" href="#" style="color:white;background: #222C32;">Roller Compactor AW</a></li>
					<li><a class="mySideMenu" href="index7.php">Coating Bosch</a></li>
				</ul>
			</div>
		</div>
		<div id="myRightPanel">
			<span class="myLabelText">Roller Compactor AW</span><br>
					...
					<div class="myKPITable">
						<table width="100%" border="0">
							<tr>
								...
								<td style="width: 33%;"><span>BAR</span></td>
							</tr>
							<tr>
								<td colspan="3"><span style="font-size: 10px; color:#757699;"><i>Hydraulic  in BAR</i></span></td>
							</tr>
							<tr>
			...
			<div class="myBlock myMixing">
				<center>
					<span class="myLabelText" style="margin: 0;">Combi Vent Feeder</span>
					<div class="o2" id="cir1"></div>
				</center>
			</div>
			<div class="myBlock myMixing">
				<center>
					<span class="myLabelText" style="margin: 0;">Roller Gap </span>
					<div class="o2" id="cir3"></div>
				</center>
			</div>
			<div class="myBlock myMixing">
				<center>
					<span class="myLabelText" style="margin: 0;">Roller Speed </span>
					<div class="o2" id="cir4"></div>
				</center>
			</div>
			<div class="myBlock myMixing">
				<center>
					<span class="myLabelText" style="margin: 0;">Flake Crusher </span>
					<div class="o2" id="cir5"></div>
				</center>
			</div>
			<div class="myBlock myMixing">
				<center>
					<span class="myLabelText" style="margin: 0;">Granulator </span>
